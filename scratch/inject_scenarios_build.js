...
function injectIntoFile(filePath) {
  ...
  for (const id in sentenceData) {
    ...
    if (content.indexOf(`buildSentence:`, content.indexOf(`id: "${id}"`)) !== -1 && 
        content.indexOf(`buildSentence:`, content.indexOf(`id: "${id}"`)) < (content.indexOf(`id: "cenario-`, content.indexOf(`id: "${id}"`) + 10) === -1 ? content.length : content.indexOf(`id: "cenario-`, content.indexOf(`id: "${id}"`) + 10))) {
