...
export const scenarios2: Scenario[] = [
  {
    ...
    speakingPractice: {
      ...
      speakingPracticeLevel2: {
                    part1: [ { question: "Did you buy new clothes last month?", translation: "Você comprou clothes novo(a) no mês passado?" }, { question: "Did you buy new shoes last month?", translation: "Você comprou shoes novo(a) no mês passado?" }, { question: "Did you buy new size last month?", translation: "Você comprou size novo(a) no mês passado?" }, { question: "Did you use a price at the store?", translation: "Você usou um(a) price na loja?" }, { question: "Did you try on the shirt before buying?", translation: "Você experimentou a camisa antes de comprar?" }, { question: "Did you buy new store / shop last month?", translation: "Você comprou store / shop novo(a) no mês passado?" }, { question: "Did you buy new fitting room last month?", translation: "Você comprou fitting room novo(a) no mês passado?" }, { question: "Did you buy new sale last month?", translation: "Você comprou sale novo(a) no mês passado?" }, { question: "Did you talk to the customer?", translation: "Você falou com o(a) customer?" }, { question: "Was the shirt expensive?", translation: "A camisa era expensive?" } ],
                    part2: [ { question: "Was the shirt cheap?", translation: "A camisa era cheap?" }, { question: "Did you use a wallet at the store?", translation: "Você usou um(a) wallet na loja?" }, { question: "Did you pay with credit card?", translation: "Você pagou com credit card?" }, { question: "Did you pay with cash?", translation: "Você pagou com cash?" }, { question: "Did you buy new jacket last month?", translation: "Você comprou jacket novo(a) no mês passado?" }, { question: "Did you buy new pants last month?", translation: "Você comprou pants novo(a) no mês passado?" }, { question: "Did you buy new dress last month?", translation: "Você comprou dress novo(a) no mês passado?" }, { question: "Did you buy new hat last month?", translation: "Você comprou hat novo(a) no mês passado?" }, { question: "Did you fix the mirror in your house?", translation: "Você consertou o(a) mirror na sua casa?" }, { question: "Did you buy new gift last month?", translation: "Você comprou gift novo(a) no mês passado?" } ]
                  },
      imageDescription: {
...
},
  {
    ...
    speakingPractice: {
      ...
      speakingPracticeLevel2: {
                    part1: [ { question: "Did you want to be a doctor when you were younger?", translation: "Você queria ser um(a) doctor quando era mais jovem?" }, { question: "Did you want to be a teacher when you were younger?", translation: "Você queria ser um(a) teacher quando era mais jovem?" }, { question: "Did you want to be a engineer when you were younger?", translation: "Você queria ser um(a) engineer quando era mais jovem?" }, { question: "Did you want to be a chef when you were younger?", translation: "Você queria ser um(a) chef quando era mais jovem?" }, { question: "Did you want to be a police officer when you were younger?", translation: "Você queria ser um(a) police officer quando era mais jovem?" }, { question: "Did you want to be a work / job when you were younger?", translation: "Você queria ser um(a) work / job quando era mais jovem?" }, { question: "Did you want to be a nurse when you were younger?", translation: "Você queria ser um(a) nurse quando era mais jovem?" }, { question: "Did you want to be a mechanic when you were younger?", translation: "Você queria ser um(a) mechanic quando era mais jovem?" }, { question: "Did you want to be a lawyer when you were younger?", translation: "Você queria ser um(a) lawyer quando era mais jovem?" }, { question: "Did you go to the office yesterday?", translation: "Você foi ao/à office ontem?" } ],
                    part2: [ { question: "Did you want to be a dentist when you were younger?", translation: "Você queria ser um(a) dentist quando era mais jovem?" }, { question: "Did you want to be a firefighter when you were younger?", translation: "Você queria ser um(a) firefighter quando era mais jovem?" }, { question: "Did you want to be a driver when you were younger?", translation: "Você queria ser um(a) driver quando era mais jovem?" }, { question: "Did you want to be a pilot when you were younger?", translation: "Você queria ser um(a) pilot quando era mais jovem?" }, { question: "Did you want to be a artist when you were younger?", translation: "Você queria ser um(a) artist quando era mais jovem?" }, { question: "Did you want to be a farmer when you were younger?", translation: "Você queria ser um(a) farmer quando era mais jovem?" }, { question: "Did you want to be a waiter when you were younger?", translation: "Você queria ser um(a) waiter quando era mais jovem?" }, { question: "Did you go to the company yesterday?", translation: "Você foi ao/à company ontem?" }, { question: "Did you want to be a boss when you were younger?", translation: "Você queria ser um(a) boss quando era mais jovem?" }, { question: "Did you get your salary last week?", translation: "Você recebeu seu salário na semana passada?" } ]
                  },
      imageDescription: {
...
},
  {
    ...
    speakingPractice: {
      ...
      speakingPracticeLevel2: {
                    part1: [ { question: "Did you go to the park yesterday?", translation: "Você foi ao/à park ontem?" }, { question: "Did you go to the hospital yesterday?", translation: "Você foi ao/à hospital ontem?" }, { question: "Did you go to the school yesterday?", translation: "Você foi ao/à school ontem?" }, { question: "Did you go to the bus stop yesterday?", translation: "Você foi ao/à bus stop ontem?" }, { question: "Did you go to the street yesterday?", translation: "Você foi ao/à street ontem?" }, { question: "Did you go to the turn left / right yesterday?", translation: "Você foi ao/à turn left / right ontem?" }, { question: "Did you go to the library yesterday?", translation: "Você foi ao/à library ontem?" }, { question: "Did you go to the bank yesterday?", translation: "Você foi ao/à bank ontem?" }, { question: "Did you go straight at the corner?", translation: "Você go straight na esquina?" }, { question: "Was the place near?", translation: "O lugar era near?" } ],
                    part2: [ { question: "Did you go to the pharmacy yesterday?", translation: "Você foi ao/à pharmacy ontem?" }, { question: "Did you go to the restaurant yesterday?", translation: "Você foi ao/à restaurant ontem?" }, { question: "Did you go to the airport yesterday?", translation: "Você foi ao/à airport ontem?" }, { question: "Did you go to the station yesterday?", translation: "Você foi ao/à station ontem?" }, { question: "Did you go to the museum yesterday?", translation: "Você foi ao/à museum ontem?" }, { question: "Was the place far?", translation: "O lugar era far?" }, { question: "Did you go to the corner yesterday?", translation: "Você foi ao/à corner ontem?" }, { question: "Did you go to the block yesterday?", translation: "Você foi ao/à block ontem?" }, { question: "Did you go to the traffic light yesterday?", translation: "Você foi ao/à traffic light ontem?" }, { question: "Did you go to the bridge yesterday?", translation: "Você foi ao/à bridge ontem?" } ]
                  },
      imageDescription: {
...
},
  {
    ...
    speakingPractice: {
      ...
      speakingPracticeLevel2: {
                    part1: [ { question: "Did you have a dog as a child?", translation: "Você teve um(a) dog quando criança?" }, { question: "Did you have a cat as a child?", translation: "Você teve um(a) cat quando criança?" }, { question: "Did you have a bird as a child?", translation: "Você teve um(a) bird quando criança?" }, { question: "Did you have a fish as a child?", translation: "Você teve um(a) fish quando criança?" }, { question: "Did you have a pet as a child?", translation: "Você teve um(a) pet quando criança?" }, { question: "Did you walk the dog this morning?", translation: "Você walk the dog hoje de manhã?" }, { question: "Did you feed this morning?", translation: "Você feed hoje de manhã?" }, { question: "Did you have a horse as a child?", translation: "Você teve um(a) horse quando criança?" }, { question: "Did you have a cow as a child?", translation: "Você teve um(a) cow quando criança?" }, { question: "Did you take your pet to the vet?", translation: "Você levou seu pet ao veterinário?" } ],
                    part2: [ { question: "Did you have a pig as a child?", translation: "Você teve um(a) pig quando criança?" }, { question: "Did you have a chicken as a child?", translation: "Você teve um(a) chicken quando criança?" }, { question: "Did you have a rabbit as a child?", translation: "Você teve um(a) rabbit quando criança?" }, { question: "Did you have a lion as a child?", translation: "Você teve um(a) lion quando criança?" }, { question: "Did you have a tiger as a child?", translation: "Você teve um(a) tiger quando criança?" }, { question: "Did you have a monkey as a child?", translation: "Você teve um(a) monkey quando criança?" }, { question: "Did you have a elephant as a child?", translation: "Você teve um(a) elephant quando criança?" }, { question: "Did the animal bark at you?", translation: "O animal bark para/em você?" }, { question: "Did the animal meow at you?", translation: "O animal meow para/em você?" }, { question: "Did the animal bite at you?", translation: "O animal bite para/em você?" } ]
                  },
      imageDescription: {
...
},
  {
    ...
    speakingPractice: {
      ...
      speakingPracticeLevel2: {
                    part1: [ { question: "Did you cook dinner last night?", translation: "Você cook o jantar na noite passada?" }, { question: "Did you bake dinner last night?", translation: "Você bake o jantar na noite passada?" }, { question: "Did you buy the recipe for the cake?", translation: "Você comprou o/a recipe para o bolo?" }, { question: "Did you buy the ingredients for the cake?", translation: "Você comprou o/a ingredients para o bolo?" }, { question: "Did you use a knife to cook?", translation: "Você usou um(a) knife para cozinhar?" }, { question: "Did you use a oven to cook?", translation: "Você usou um(a) oven para cozinhar?" }, { question: "Did you boil dinner last night?", translation: "Você boil o jantar na noite passada?" }, { question: "Did you fry dinner last night?", translation: "Você fry o jantar na noite passada?" }, { question: "Did you chop dinner last night?", translation: "Você chop o jantar na noite passada?" }, { question: "Did you use a spoon to cook?", translation: "Você usou um(a) spoon para cozinhar?" } ],
                    part2: [ { question: "Did you use a fork to cook?", translation: "Você usou um(a) fork para cozinhar?" }, { question: "Did you use a plate to cook?", translation: "Você usou um(a) plate para cozinhar?" }, { question: "Did you use a bowl to cook?", translation: "Você usou um(a) bowl para cozinhar?" }, { question: "Did you mix dinner last night?", translation: "Você mix o jantar na noite passada?" }, { question: "Did you pour dinner last night?", translation: "Você pour o jantar na noite passada?" }, { question: "Did you taste dinner last night?", translation: "Você taste o jantar na noite passada?" }, { question: "Was the food too spicy?", translation: "A comida estava muito spicy?" }, { question: "Was the food too sweet?", translation: "A comida estava muito sweet?" }, { question: "Was the food too salty?", translation: "A comida estava muito salty?" }, { question: "Did you use a pan to cook?", translation: "Você usou um(a) pan para cozinhar?" } ]
                  },
      imageDescription: {
...
},
  {
    ...
    speakingPractice: {
      ...
      speakingPracticeLevel2: {
                    part1: [ { question: "Did you use your laptop this morning?", translation: "Você usou seu/sua laptop hoje de manhã?" }, { question: "Did you use your smartphone this morning?", translation: "Você usou seu/sua smartphone hoje de manhã?" }, { question: "Did you use your internet this morning?", translation: "Você usou seu/sua internet hoje de manhã?" }, { question: "Did you use your keyboard this morning?", translation: "Você usou seu/sua keyboard hoje de manhã?" }, { question: "Did you use your screen this morning?", translation: "Você usou seu/sua screen hoje de manhã?" }, { question: "Did you download the file?", translation: "Você download o arquivo?" }, { question: "Did you use your password this morning?", translation: "Você usou seu/sua password hoje de manhã?" }, { question: "Did you use your charger this morning?", translation: "Você usou seu/sua charger hoje de manhã?" }, { question: "Did you use your app this morning?", translation: "Você usou seu/sua app hoje de manhã?" }, { question: "Did you use your mouse this morning?", translation: "Você usou seu/sua mouse hoje de manhã?" } ],
                    part2: [ { question: "Did you upload the file?", translation: "Você upload o arquivo?" }, { question: "Did you use your battery this morning?", translation: "Você usou seu/sua battery hoje de manhã?" }, { question: "Did you use your email this morning?", translation: "Você usou seu/sua email hoje de manhã?" }, { question: "Did you use your website this morning?", translation: "Você usou seu/sua website hoje de manhã?" }, { question: "Did you use your link this morning?", translation: "Você usou seu/sua link hoje de manhã?" }, { question: "Did you save the file?", translation: "Você save o arquivo?" }, { question: "Did you delete the file?", translation: "Você delete o arquivo?" }, { question: "Did you use your folder this morning?", translation: "Você usou seu/sua folder hoje de manhã?" }, { question: "Did you use your headphones this morning?", translation: "Você usou seu/sua headphones hoje de manhã?" }, { question: "Did you plug in the file?", translation: "Você plug in o arquivo?" } ]
                  },
      imageDescription: {
...
},
  {
    ...
    speakingPractice: {
      ...
      speakingPracticeLevel2: {
                    part1: [ { question: "Did you like a photo yesterday?", translation: "Você like uma foto ontem?" }, { question: "Did you follow a photo yesterday?", translation: "Você follow uma foto ontem?" }, { question: "Did you post a photo yesterday?", translation: "Você post uma foto ontem?" }, { question: "Did you share with your friends recently?", translation: "Você share com seus amigos recentemente?" }, { question: "Did you check your profile on social media?", translation: "Você checou seu/sua profile nas redes sociais?" }, { question: "Did you message a photo yesterday?", translation: "Você message uma foto ontem?" }, { question: "Did you comment a photo yesterday?", translation: "Você comment uma foto ontem?" }, { question: "Did you check your hashtag on social media?", translation: "Você checou seu/sua hashtag nas redes sociais?" }, { question: "Did you scroll a photo yesterday?", translation: "Você scroll uma foto ontem?" }, { question: "Did you check your follower on social media?", translation: "Você checou seu/sua follower nas redes sociais?" } ],
                    part2: [ { question: "Did you feed this morning?", translation: "Você feed hoje de manhã?" }, { question: "Did you tag a photo yesterday?", translation: "Você tag uma foto ontem?" }, { question: "Did you check your story on social media?", translation: "Você checou seu/sua story nas redes sociais?" }, { question: "Did you check your influencer on social media?", translation: "Você checou seu/sua influencer nas redes sociais?" }, { question: "Did you see that viral online?", translation: "Você viu aquele viral na internet?" }, { question: "Did you see that meme online?", translation: "Você viu aquele meme na internet?" }, { question: "Did you go to the block yesterday?", translation: "Você foi ao/à block ontem?" }, { question: "Did you check your notification on social media?", translation: "Você checou seu/sua notification nas redes sociais?" }, { question: "Did you check your update on social media?", translation: "Você checou seu/sua update nas redes sociais?" }, { question: "Did you check your account on social media?", translation: "Você checou seu/sua account nas redes sociais?" } ]
                  },
      imageDescription: {
